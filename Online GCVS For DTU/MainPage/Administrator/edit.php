    ...
    <body>
        ...
        <table class="form">
            <tr>
                ...
                <td>
                    <input type="text" placeholder="First Name" name="firstname" value="<?php echo $fetch['First_Name'] ?>" pattern="[a-zA-Z]*">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" placeholder="Middle  Name" name="middlename" value="<?php echo $fetch['Middle_Name'] ?>" pattern="[a-zA-Z]*">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" placeholder="Last Name" name="lastname" value="<?php echo $fetch['Last_Name'] ?>" pattern="[a-zA-Z]*">
                </td>
            </tr>
            <tr>
                    <td>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="../Registral/studentImages/<?php echo $fetch['Photo'] ?>" width="50px"><br>
                    </td>
                </tr>
                <tr>
                    <td>
