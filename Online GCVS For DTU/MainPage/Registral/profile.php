...
$user=mysqli_fetch_assoc(mysqli_query($con,"SELECT *FROM registral_profile WHERE id=$sessionId"));
?>
<!DOCTYPE html>
<html>
    <head>
        <title>Registral Director  Profile</title>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    if(isset($_FILES["image"]["name"])){
        ...
        if(!in_array($imageExtension, $validImageExtension)){
            ...
            $query="UPDATE registral_profile SET image='$newImageName' WHERE id=$id";
    ...
    <div class="information">
        ...
        User Type: Director Of Registral<br><br>
