    ...
    <head>
        ...
        <body>
            <section class="back">
                ...
                include('config.php');
                            $studid=$_GET['studid'];
                            $sql = "SELECT * FROM computer_student_lists WHERE Graduate_ID='$studid'";
                            $result = mysqli_query($con, $sql);

                            $sql2 = "SELECT * FROM electrical WHERE Graduate_ID='$studid'";
                            $result2 = mysqli_query($con, $sql2);

                            $sql3 = "SELECT * FROM chemical WHERE Graduate_ID='$studid'";
                            $result3 = mysqli_query($con, $sql3);

                            $sql4 = "SELECT * FROM it WHERE Graduate_ID='$studid'";
                            $result4 = mysqli_query($con, $sql4);

                            $sql5 = "SELECT * FROM law WHERE Graduate_ID='$studid'";
                            $result5 = mysqli_query($con, $sql5);

                            $sql6 = "SELECT * FROM managment WHERE Graduate_ID='$studid'";
                            $result6 = mysqli_query($con, $sql6);

                            $sql7 = "SELECT * FROM nursing WHERE Graduate_ID='$studid'";
                            ...
                            if (mysqli_num_rows($result) === 1) {
                                ...
                                if ($row['Graduate_ID'] === $studid) {
                                    $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                    $select="SELECT *FROM computer_student_lists where Graduate_ID='$studid'";
                                    ...
                                    <div class="div">
                                        ...
                                        if($data){
                                            ...
                                            deleteAll('C:\Users\fuye4\OneDrive\Documents\Back_Info_About_Graduate_Students');
                                            if(mkdir("C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students" , 0777)){
                                            }
                                            else{
                                                echo "failed to create directory ";
                                            }
                                            imagejpeg($img_source,'C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/'.$name.'.jpg');
                                            $pdf=new FPDF('L','in',[11.7,8.27]);
                                            $pdf->AddPage();
                                            $pdf->Image("C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/".$name.".jpg",0,0,11.7,8.27);
                                            $pdf->Output("C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/".$name.".pdf","F");
                                            imagedestroy($img_source);
                                            echo "<h2 style='text-align:center;margin:200px;font-family:Lobster;font-size:22px;color:#123256;'>student result is saved in your document<br> IN <br> <span style='font-size:20px; color:#1119FF;'>C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/ </span></h2>";
                                            ?>
                                            <?php
                                            }
                                        }
                                            ...
                                            <?php
                                              ...
                                              // give credential for computer science students
                                                ...
                                                if ($row['Graduate_ID'] === $studid) {
                                                    $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                    $select="SELECT *FROM electrical where Graduate_ID='$studid'";
                                                    $select_d=mysqli_query($con,$select);
                                                    $data=mysqli_num_rows($select_d);
                                                ...
                                                if ($row['Graduate_ID'] === $studid) {
                                                    $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                    $select="SELECT *FROM chemical where Graduate_ID='$studid'";
                                                    $select_d=mysqli_query($con,$select);
                                                    $data=mysqli_num_rows($select_d);
                                                   ...
                                                   // give credential for IT students
                                                    ...
                                                    if ($row['Graduate_ID'] === $studid) {
                                                        $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                        $select="SELECT *FROM it where Graduate_ID='$studid'";
                                                        $select_d=mysqli_query($con,$select);
                                                        $data=mysqli_num_rows($select_d);
                                                    ...
                                                    if ($row['Graduate_ID'] === $studid) {
                                                        $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                        $select="SELECT *FROM law where Graduate_ID='$studid'";
                                                        $select_d=mysqli_query($con,$select);
                                                        $data=mysqli_num_rows($select_d);
                                                    ...
                                                    if ($row['Graduate_ID'] === $studid) {
                                                        $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                        $select="SELECT *FROM managment where Graduate_ID='$studid'";
                                                        $select_d=mysqli_query($con,$select);
                                                        $data=mysqli_num_rows($select_d);
                                               ...
                                               // give credential for veternary_science students
                                                    ...
                                                    if ($row['Graduate_ID'] === $studid) {
                                                        $_SESSION['Graduate_ID'] = $row['Graduate_ID'];
                                                        $select="SELECT *FROM nursing where Graduate_ID='$studid'";
                                                        $select_d=mysqli_query($con,$select);
                                                        $data=mysqli_num_rows($select_d);
                                                        ...
                                                        <div class="div">
                                                            ...
                                                            if($data){
                                                                ...
                                                                $pdf->Output("C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/".$name.".pdf","F");
                                                                imagedestroy($img_source);
                                                                echo "<h2 style='text-align:center; color:green;margin:200px;font-family:Lobster;font-size:22px;color:#90B9FF;'>student credential is saved in your document<br> IN <br> <span style='font-size:20px; color:#90B9FF;'>C:/Users/fuye4/OneDrive/Documents/Back_Info_About_Graduate_Students/ </span></h2>";
                                                                ?>
                                                                <?php
                                                                }
                                                            }
